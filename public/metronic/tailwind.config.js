...
module.exports = {
	...
	plugins: [
		...
		require('./src/core/plugins/layouts/demo1'),
		require('./src/core/plugins/components/theme'),
		require('./src/core/plugins/components/breakpoints'),		
		require('./src/core/plugins/components/typography'),
		require('./src/core/plugins/components/menu'),
		require('./src/core/plugins/components/dropdown'),
		require('./src/core/plugins/components/accordion'),
		require('./src/core/plugins/components/input'),
		require('./src/core/plugins/components/input-group'),
		require('./src/core/plugins/components/select'),
		require('./src/core/plugins/components/textarea'),
		require('./src/core/plugins/components/file-input'),
		require('./src/core/plugins/components/switch'),
		require('./src/core/plugins/components/checkbox'),
		require('./src/core/plugins/components/radio'),
		require('./src/core/plugins/components/range'),
		require('./src/core/plugins/components/container'),
		require('./src/core/plugins/components/image-input'),
		require('./src/core/plugins/components/modal'),
		require('./src/core/plugins/components/drawer'),
		require('./src/core/plugins/components/tooltip'),
		require('./src/core/plugins/components/popover'),
		require('./src/core/plugins/components/btn'),
		require('./src/core/plugins/components/btn-group'),
		require('./src/core/plugins/components/tabs'),
		require('./src/core/plugins/components/pagination'),
		require('./src/core/plugins/components/card'),
		require('./src/core/plugins/components/table'),
		require('./src/core/plugins/components/badge'),
		require('./src/core/plugins/components/rating'),
		require('./src/core/plugins/components/scrollable'),
		require('./src/core/plugins/components/progress'),
		require('./src/core/plugins/components/apexcharts'),
		require('./src/core/plugins/components/leaflet')
	]
};
