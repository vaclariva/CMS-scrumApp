<div class="card mb-3 backlog-edit" data-backlog-id="{{ $backlog->id }}">
    <div class="BacklogNameDisplay card-body title-backlog mb-0">
        <input type="text" class="card-title title-card-backlog cstm-input" data-product-id="{{ $product->id }}" data-id="{{ $backlog->id }}" name="titles" id="name-backlog-{{ $backlog->id }}" value="{{ $backlog->name }}">
    </div>
