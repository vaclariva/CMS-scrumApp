        ...
        <div class="modal-body">
            <form id="user-form" action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group p-2">
                    <label class="text-sm" for="image"><strong>Foto</strong></label>
                        <input id="image-upload" name="image" type="file" accept=".png, .jpg, .jpeg" hidden/>
                            <div class="flex justify-start items-center">
                                <div class="image-input size-16" data-image-input="false" id="parent-upload">
                                ...
                                <span class="tooltip" id="image_input_tooltip">
                                    ...
                                    style="background-image: url('metronic/dist/assets/media/avatars/blank.png');">
                                        <div class="image-input-preview rounded-full"
                                                style="background-image: url('/static/metronic/tailwind/docs/dist/assets/media/avatars/300-2.png');">
                                        </div>
                ...
                <div class="form-group p-2">
                    <label class="text-sm" for="peran"><strong>Peran</strong></label>
