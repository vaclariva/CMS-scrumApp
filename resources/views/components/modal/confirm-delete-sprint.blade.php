<div class="modal" data-modal="true" id="delete_sprint{{ $sprint->id }}">
    <div class="modal-content max-w-[450px] top-[10%] p-3">
        ...
        <div class="modal-footer flex justify-center p-3">
            <div class="flex gap-4">
                ...
                <form id="delete-form" action="{{ route('sprints.destroy', [$product->id, $sprint->id]) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
